...
//			'lastmodified'	=> array( 'desc'=> _AM_WIWI_LISTPAGES_LASTMODIFIED_OPT,	'type' =>'date'),
	...
	$selOrder = Array(
		...
		Array ('desc' => _AM_WIWI_LISTPAGES_TITLE_OPT,			'col' => 'title' ),
		Array ('desc' => _AM_WIWI_LISTPAGES_PARENT_OPT,			'col' => 'parent' ),
		Array ('desc' => _AM_WIWI_LISTPAGES_LASTMODIFIED_OPT, 	'col' => 'lastmodified' ),
		);

	$selOrderDir = Array(
		Array ('desc' => _AM_WIWI_LISTPAGES_ORDERASC_OPT,		'col' => 'ASC' ),
		Array ('desc' => _AM_WIWI_LISTPAGES_ORDERDESC_OPT,		'col' => 'DESC' ),
		);
