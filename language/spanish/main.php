...
define('_MD_WIWI_MODIFIED_TXT', 'Página modificada el:');
...
define('_MD_WIWI_QUIETSAVE_BTN','Grabar');//Comprobar el sentido
...
if (!defined('_MI_WIWI_HOME')){define('_MI_WIWI_HOME','Inicio');} // Also need in modinfo.php
define('_MI_WIWI_404','Nombre no permitido');//Comprobar la validez del nombre

// Added in version 1.0
define('_MI_WIWI_REVISION_SUMMARY', 'Resumen de revisiones');
define('_MI_WIWI_ALLOW_COMMENTS','Permitir comentarios');
