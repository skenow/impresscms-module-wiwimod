...
define('_MI_WIWIMOD_TEMPLATE_VIEW_DESC','Ver página');
define('_MI_WIWIMOD_TEMPLATE_EDIT_DESC','Modificar página');
define('_MI_WIWIMOD_TEMPLATE_HISTORY_DESC','Ver historial de la página');
define('_MI_WIWIMOD_TEMPLATE_PDF_DESC','SimplyWiki - pdf');
...
define('_MI_WIWIMOD_DEFAULTPROFILE_DESC','Perfil predeterminado asignado a las nuevas páginas');
if (!defined('_MI_WIWIMOD_HOME')){define('_MI_WIWIMOD_HOME','Inicio');}
?>