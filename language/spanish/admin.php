...
define('_AM_SWIKI_PAGESFILTER_TXT','Listar las páginas en que ');
...
define('_AM_SWIKI_ACLHELP_TXT','
	<p>El sistema de privilegios de acceso está relacionado con los grupos de usuarios que haya creado, pudiendo seleccionar los que están autorizados a leer, modificar o administrar las páginas correspondientes.</p>
	<ul>
...
define('_AM_SWIKI_DELCONFIRM_TXT','Va a suprimir un perfil: confirme su intención.');
define('_AM_SWIKI_DELREDIR_TXT','Elija un perfil para las páginas actualmente protegidas por el que está suprimiendo.');

define('_AM_SWIKI_LISTPAGES_BTN','<< Vuelta a la lista de páginas');
