...
<li>Sistema de notificaciones de cambios: se puede elegir recibir un mensaje privado o correo electrónico cuando una página sea modificada, cuando se escriba un comentario sobre la misma, para tener seguimiento de un contenido determinado, cuando se restaura alguna página o incluso cuando se modifique cualquier página.</li>
...
<li>Desde la versión 1.2 tiene la posibilidad de admitir el uso de lector de RSS. </li>
</ul>
...
<tr valign="top">
<td width="30%">&lt;[Children]&gt;</td>
<td width="70%">Muestra las subpáginas de la que se esté visualizando.</td>
</tr>
<tr valign="top">
<td width="30%">&lt;[Siblings]&gt;</td>
<td width="70%">Muestra las páginas que tengan la misma importancia o rango que la que se visualiza.</td>
</tr>
<tr valign="top">
