...
define('_AM_SWIKI_ADMIN_TXT','Skrbništvo Modula');
define('_AM_SWIKI_PAGESFILTER_TXT','Pokaži strani katerih');
define('_AM_SWIKI_LIKE_TXT','vsebina');
define('_AM_SWIKI_PROFILEIS_TXT','je');
define('_AM_SWIKI_ORDERBY_TXT',', razvršèeno po');
...
define('_AM_SWIKI_ACLHELP_TXT','
	...
	');
define('_AM_SWIKI_DELCONFIRMTITLE_TXT','IZBRIŠITE POTRDITEV PROFILA');
define('_AM_SWIKI_DELCONFIRM_TXT','Ste tik pred tem, da izbrišete profil. Potrdite z oznaèitvijo potrditvenega okenca.');
...
define('_AM_SWIKI_EDITACL_DELETE_BTN','Izbriši');
define('_AM_SWIKI_EDITACL_CANCEL_BTN','Preklièi');
define('_AM_SWIKI_CLEANUPDB_BTN','Poèisti podatkovno bazo');
...
define('_AM_SWIKI_ADMINISTRATORS_FLD','Skupine z skrbniškim statusom');
...
define('_AM_SWIKI_DELCONFIRM_OPT','Ja, želim izbrisati ta profil.');
...
define('_AM_SWIKI_LISTPAGES_ORDERDESC_OPT','padajoèe');
define('_AM_SWIKI_LISTPAGES_ORDERASC_OPT','narašèajoèe');
...
define('_AM_SWIKI_CONFIRMDEL_MSG','Ste preprièani v izbris te strani');
define('_AM_SWIKI_CONFIRMFIX_MSG','Ste preprièani, da želite popraviti to stran');
define('_AM_SWIKI_CONFIRMCLEAN_MSG','Ali ste preprièani v oèišèenje podatkovne baze');
define('_AM_SWIKI_PRFSAVESUCCESS_MSG','Profil uspešno shranjen v podatkovno bazo');
define('_AM_SWIKI_PRFSAVEFAILED_MSG','Med shranjevanjem profila je prišlo do napake. Podatkovna baza NI POSODOBLJENA');
...
define('_AM_SWIKI_PRFDELFAILED_MSG','Pri brisanju profila je prišlo do napake. Podatkovna baza NI POSODOBLJENA');
