...
define('_MD_SWIKI_DIFF_TXT','Razlike med trenutno in najnovejšo razlièico');
...
define('_MD_SWIKI_PAGENOTFOUND_MSG',"Ta stran še ne obstaja.");
define('_MD_SWIKI_DBUPDATED_MSG','Podatkovna baza uspešno posodobljena!');
define('_MD_SWIKI_ERRORINSERT_MSG','Pri posodabljanju podatkovne baze je prišlo do napak!');
