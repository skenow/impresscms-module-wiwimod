...
define('_MB_SWIKI_PAGENOTFOUND_MSG',"<br>Deze pagina bestaat nog niet.<br>");
define('_MB_SWIKI_NOREADACCESS_MSG',"<br><h4>Helaas,... u hebt geen toegang tot deze pagina.</h4><br>");
