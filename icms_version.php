...
// Templates
$modversion['templates'][1] = array ('file' => 'wiwimod_view.html','description' => _MI_SWIKI_TEMPLATE_VIEW_DESC
);
$modversion['templates'][] = array ('file' => 'wiwimod_edit.html','description' => _MI_SWIKI_TEMPLATE_EDIT_DESC
);
$modversion['templates'][] = array ('file' => 'wiwimod_history.html','description' => _MI_SWIKI_TEMPLATE_HISTORY_DESC
);
$modversion['templates'][] = array ('file' => 'wiwimod_pdf.html','description' => _MI_SWIKI_TEMPLATE_PDF_DESC
);

// Search
$modversion['hasSearch'] = 1;
$modversion['search'] = array ('file' => 'include/search.php','func' => 'swiki_search'
);

// Comments
$modversion['hasComments'] = 1;
$modversion['comments'] = array ('itemName' => 'pageid','pageName' => 'index.php'
);

// Blocks
$modversion['blocks'][1] = array ('file' => 'wiwimod_toc.php','name' => _MI_SWIKI_BLOCK_TOC_NAME,'description' => _MI_SWIKI_BLOCK_TOC_DESC,'show_func' => 'swiki_toc','template' => 'wiwimod_toc.html','can_clone' => true
);

$modversion['blocks'][] = array ('file' => 'wiwimod_recent.php','name' => _MI_SWIKI_BLOCK_RECENT_NAME,'description' => _MI_SWIKI_BLOCK_RECENT_DESC,'show_func' => 'swiki_recent','edit_func' => 'swiki_recent_blockedit','options' => '5','template' => 'wiwimod_recent.html','can_clone' => true
);

$modversion['blocks'][] = array ('file' => 'wiwimod_showpage.php','name' => _MI_SWIKI_BLOCK_RELATED_NAME,'description' => _MI_SWIKI_BLOCK_RELATED_DESC,'show_func' => 'swiki_contextshow','template' => 'wiwimod_context.html','can_clone' => true
);
...
$modversion['blocks'][] = array ('file' => 'swiki_blocks.php','name' => _MI_SWIKI_BLOCK_ADDPAGE_NAME,'description' => _MI_SWIKI_BLOCK_ADDPAGE_DESC,'show_func' => 'swiki_addpage','template' => 'swiki_addpage.html','can_clone' => true
);
...
$modversion['config'][] = array ('name' => 'DefaultProfile','title' => '_MI_SWIKI_DEFAULTPROFILE','description' => '_MI_SWIKI_DEFAULTPROFILE_DESC','formtype' => 'select','valuetype' => 'int','default' => 0,'options' => array ()
);

$modversion['config'][] = array ('name' => 'allowPDF','title' => '_MI_SWIKI_ALLOWPDF','description' => '_MI_SWIKI_ALLOWPDF_DESC','formtype' => 'yesno','valuetype' => 'int','default' => 0
);

$modversion['config'][] = array ('name' => 'ShowTitles','title' => '_MI_SWIKI_SHOWTITLES','description' => '_MI_SWIKI_SHOWTITLES_DESC','formtype' => 'yesno','valuetype' => 'int','default' => 0
);

$modversion['config'][] = array ('name' => 'ShowCamelCase','title' => '_MI_SWIKI_USECAMELCASE','description' => '_MI_SWIKI_USECAMELCASE_DESC','formtype' => 'yesno','valuetype' => 'int','default' => 0
);

$modversion['config'][] = array ('name' => 'TopPage','title' => '_MI_SWIKI_TOPPAGE','description' => '_MI_SWIKI_TOPPAGE_DESC','formtype' => 'textbox','valuetype' => 'text','default' => _MI_SWIKI_HOME
);
...
$modversion['config'][] = array (
		...
		'valuetype' => 'array',
		'options' => array ('_MI_SWIKI_SHOWREVISIONS' => 'ShowRevisions','_MI_SWIKI_SHOWVIEWS' => 'ShowViews','_MI_SWIKI_SHOWCREATED' => 'ShowCreated','_MI_SWIKI_SHOWLASTREVISED' => 'ShowLastRevised','_MI_SWIKI_LASTVIEWED' => 'ShowLastViewed'
		),
		'default' => 'ShowLastRevised'
);

$modversion['config'][] = array ('name' => 'Captcha','title' => '_MI_SWIKI_USECAPTCHA','description' => '_MI_SWIKI_USECAPTCHA_DESC','formtype' => 'yesno','valuetype' => 'int','default' => 1
);

$modversion['config'][] = array ('name' => 'ShowQuickAdd','title' => '_MI_SWIKI_SHOWQUICKADD','description' => '_MI_SWIKI_SHOWQUICKADD_DESC','formtype' => 'yesno','valuetype' => 'int','default' => 1
);

// Notification

$modversion['hasNotification'] = 1;
$modversion['notification'] = array ('lookup_file' => 'include/notification.inc.php','lookup_func' => 'swiki_notify_iteminfo'
);

$modversion['notification']['category'][1] = array ('name' => 'page','title' => _MI_SWIKI_PAGENOTIFYCAT_TITLE,'description' => '_MI_SWIKI_PAGENOTIFYCAT_DESC','subscribe_from' => array ('index.php'
),'allow_bookmark' => 1,'item_name' => 'pageid'
...
$modversion['notification']['category'][] = array ('name' => 'global','title' => _MI_SWIKI_GLOBALNOTIFYCAT_TITLE,'description' => '_MI_SWIKI_GLOBALNOTIFYCAT_DESC','subscribe_from' => array ('index.php'
),'item_name' => ''
); // must be a numeric value passed in a $_GET variable, or empty for global matching. See ROOT/include/notification_functions.php
