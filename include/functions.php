...
function getAdminMenu ($currentoption = 0, $breadcrumb = '')
{
	...
	if (file_exists(XOOPS_ROOT_PATH . '/modules/wiwimod/language/' . $xoopsConfig['language'] . '/modinfo.php')) {
		include_once XOOPS_ROOT_PATH . '/modules/wiwimod/language/' . $xoopsConfig['language'] . '/modinfo.php';
	} else {
		include_once XOOPS_ROOT_PATH . '/modules/wiwimod/language/english/modinfo.php';
	}
